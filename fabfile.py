...
# CHANGEME
env.hosts = ['user@skyscanner.example.com']
env.code_dir = '/srv/www/skyscanner'
env.project_dir = '/srv/www/skyscanner/skyscanner'
env.static_root = '/srv/www/skyscanner/static/'
env.virtualenv = '/srv/www/skyscanner/.virtualenv'
env.code_repo = 'git@github.com:user/skyscanner.git'
env.django_settings_module = 'skyscanner.settings'
